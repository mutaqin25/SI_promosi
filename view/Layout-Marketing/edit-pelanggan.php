            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        ?>
                            <form method="post" action="../../action/edit-pelanggan.php">
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-5">
                                        <input type="text" name="id_pelanggan" value="<?php echo $d['id_pelanggan'] ?>" class="form-control" placeholder=" Nama" hidden>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="number" name="no_hp" value="<?php echo $d['no_hp'] ?>" required class="form-control" placeholder="Nomor Handphone">
                                    </div>
                                </div>
                                <div class="form-group row">
