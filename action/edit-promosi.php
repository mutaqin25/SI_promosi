...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($conn, "DELETE FROM promosi WHERE kd_promosi='$_POST[id]'");
    mysqli_query($conn, "DELETE FROM kriteria_promosi WHERE kd_promosi='$_POST[id]'");
    ...
    ('$id_kt', '$id_produk', '$kd1', '$V[0]', '$V[1]', '$V[2]', '$V[3]', '$V[4]', '$max')
    ";
    ...
    if ($query) {
        ...
        $_SESSION['message'] = "<strong>Sukses!</strong> Data Berhasil Diubah!";
        header('Location: ../view/Layout-Marketing/form-promosi.php');
    } else {
        // kalau gagal alihkan ke halaman indek.php dengan status=gagal
        $_SESSION['status'] = "gagal";
        $_SESSION['message'] = "<strong>Gagal!</strong> Data Gagal Diubah!";
        header('Location: ../view/Layout-Marketing/form-promosi.php');
    }
} else {
