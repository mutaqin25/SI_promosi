...
if (isset($_POST['simpan'])) {
    ...
    $sql = "INSERT INTO promosi (id_promosi, periklanan, penjualanpersonal, promosipenjualan, publisitas, pemasaranlangsung, id_pengguna) VALUE 
    ('$id', '$A1[0]', '$A1[1]', '$A1[2]', '$A1[3]', '$A1[4]', '$id_pengguna'), 
    ('$id+2', '$A2[0]', '$A2[1]', '$A2[2]', '$A2[3]', '$A2[4]', '$id_pengguna'), 
    ('$id+3', '$A3[0]', '$A3[1]', '$A3[2]', '$A3[3]', '$A3[4]', '$id_pengguna'), 
    ('$id+4', '$A4[0]', '$A4[1]', '$A4[2]', '$A4[3]', '$A4[4]', '$id_pengguna'),
    ('$id+5', '$A5[0]', '$A5[1]', '$A5[2]', '$A5[3]', '$A5[4]', '$id_pengguna'), 
    ";
